...
def get_arg_parser():
    ...
    input_img_args.add_argument('--image_path',
                                default=[], type=str,
                                help='if given and --dir not given, run on single image instead of folder (cannot train with this option)')
    ...
    model_args.add_argument('--pretrained_model', required=False, default='cyto', type=str,
    ...
    output_args.add_argument('--save_png', action='store_true',
    ...
    output_args.add_argument('--dir_above', action='store_true',
                             help='save output folders adjacent to image folder instead of inside it (off by default)')
    ...
    training_args.add_argument('--mask_filter',
                               ...
                               help='end string for masks to run on. use "_seg.npy" for manual annotations from the GUI. Default: %(default)s')
